...
namespace AcademyGroupLibrary
{
    public class AcademyGroup
    {
        ...
        public void SearchStudent(int criterion, string value)
        {
            ...
            {
                1 => _students.FindAll(s => s.Name.Equals(value, StringComparison.OrdinalIgnoreCase)),
                2 => _students.FindAll(s => s.Surname.Equals(value, StringComparison.OrdinalIgnoreCase)),
                3 => _students.FindAll(s => s.Phone.Equals(value, StringComparison.OrdinalIgnoreCase)),
                4 => _students.FindAll(s => s.Age.ToString().Equals(value)),
                5 => _students.FindAll(s => s.Average.ToString().Equals(value)),
                6 => _students.FindAll(s => s.NumberOfGroup.ToString().Equals(value)),
                _ => null
            };
